...
//  return 0;
    ...
    std::cout << "Ожидается: 3x^2 - 2x + 1 (copy of p2)" << std::endl << "p3: ";
    p3.print();
    std::cout << std::endl;
    ...
    p1 = p2;
    std::cout << "Ожидается: 3x^2 - 2x + 1 (after p1 = p2)" << std::endl << "p1: ";
    p1.print();
    std::cout << std::endl;

    // --- Тестирование оператора [] ---
    std::cout << "Testing operator []:" << std::endl;
    std::cout << "Ожидается: 3 (p2[2])" << std::endl << "p2[2]: " << p2[2] << std::endl;
    std::cout << "Ожидается: -2 (p2[1])" << std::endl << "p2[1]: " << p2[1] << std::endl;
    p2[0] = 5;
    std::cout << "Ожидается: 3x^2 - 2x + 5 (after p2[0] = 5)" << std::endl << "p2: ";
    p2.print();
    std::cout << std::endl;
    ...
    p4 *= p5;
    std::cout << "Ожидается: x^3 + x^2 - x - 1 (p4 *= p5)" << std::endl << "p4: ";
    p4.print();
    std::cout << std::endl;
    ...
    ++p4;
    std::cout << "Ожидается: x^3 + x^2 - x (after ++p4)" << std::endl << "p4: ";
    p4.print();

    p4--;
    std::cout << "Ожидается: x^3 + x^2 - x - 1 (after p4--)" << std::endl << "p4: ";
    p4.print();
    std::cout << std::endl;

    // --- Тестирование логических операторов (<, >, ==, !=) ---
    std::cout << "Testing logical operators:" << std::endl;
    std::cout << "Ожидается: true (p2 == p3)" << std::endl << "p2 == p3: " << (p2 == p3) << std::endl;
    std::cout << "Ожидается: true (p2 != p4)" << std::endl << "p2 != p4: " << (p2 != p4) << std::endl;
    std::cout << "Ожидается: результат может быть true или false (p2 < p4)" << std::endl << "p2 < p4: " << (p2 < p4) << std::endl;
    std::cout << "Ожидается: результат может быть true или false (p4 > p3)" << std::endl << "p4 > p3: " << (p4 > p3) << std::endl;
    std::cout << std::endl;

    // --- Тестирование оператора преобразования типа к базовому типу ---
    std::cout << "Testing type conversion operator:" << std::endl;
    double constantTerm = static_cast<double>(p2);
    std::cout << "Ожидается: значение свободного члена p2 (5)" << std::endl << "Constant term of p2: " << constantTerm << std::endl;
    std::cout << std::endl;
